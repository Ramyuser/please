...
def city_name():
    ...
    wearther_info=api_output_json['wearther'][0]["main"]
    print(wearther_info)
     
    humidity=api_output_json['main']['humidity']
    print(str(humidity)+"%")
    wearther_info_label["text"]="Wearther: "+str(wearther_info)
    humidity_info_label["text"]="Hunidity: "+str(humidity)+"%"
